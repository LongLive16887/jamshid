  ...
  (exports.modules = {
    ...
    524: (t, a, i) => {
      ...
      let e = i(810),
        ...
        r = i(1865);
      async function s(t) {
        let { Component: a, ctx: i } = t;
        return { pageProps: await (0, r.loadGetInitialProps)(a, i) };
      }
      class h extends c.default.Component {
        render() {
          let { Component: t, pageProps: a } = this.props;
          return (0, l.jsx)(t, { ...a });
        }
      }
      ...
      class c extends l.Component {
        render() {
          ...
          return (0, e.jsxs)("svg", {
            ...
            children: [
              e.jsx("title", { children: "career process" }),
              e.jsx("rect", {
                x: "155",
                y: "304.52",
                width: "130.73",
